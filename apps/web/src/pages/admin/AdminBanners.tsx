  ...
  return (
    <div>
      <div className="flex justify-between items-center mb-8">
        ...
        <Button onClick={() => navigate('/admin/banners/new')} className="bg-gradient-to-r from-indigo-500 via-violet-500 to-fuchsia-500 hover:from-indigo-600 hover:via-violet-600 hover:to-fuchsia-600">
